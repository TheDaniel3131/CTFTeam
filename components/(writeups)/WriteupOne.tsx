    ...
    return (
        <div className="flex flex-col items-center justify-center mb-19 mt-20">
            ...
            <Image
                ...
                height={400}
                unoptimized
                className="rounded-2xl text-center mt-10 mb-20"
            />  
            <p className="text-justify text-wrap text-lg font-DMS w-3/5 h-4/5 mb-10">
            ...
            />
            <p className="text-justify text-wrap text-lg font-DMS w-3/5 h-3/5">
            ...
            <Image
                ...
                height={400}
                unoptimized
                className="rounded-2xl text-center mt-10"
            />
            <Image
                ...
                className="rounded-2xl text-center mt-10"
            />
                <p className=" text-justify text-wrap text-lg font-DMS w-3/5 h-3/5 mb-32">
